...
export const myProjects = [
  ...
  {
    id: 6,
    title: "Construction Finance ETL & Cost Variance BI",
    desc:
      "SQL, Power Query, Excel, Python, and Power BI workflows that centralized construction-site cost data and surfaced budget risk earlier.",
    subdesc: [
      "Automated financial ETL routines and saved 30+ hours per month across monthly reporting cycles.",
      "Centralized operational and project data from 5+ sites into a unified SQL database for a $2.5M+ project portfolio.",
      "Prevented $250K+ in cost overruns through budget-vs-actual variance dashboards and lightweight forecasting.",
    ],
    href: "",
    spotlight: asset("assets/projects/kpi-governance.svg"),
    tags: [
      { id: 1, name: "SQL", path: asset("assets/logos/postgresql.svg") },
      { id: 2, name: "Power BI", path: asset("assets/logos/power-bi.svg") },
      { id: 3, name: "Excel", path: asset("assets/logos/vba.svg") },
      { id: 4, name: "Python", path: asset("assets/logos/python.svg") },
    ],
  },
];
...
export const experiences = [
  ...
  },
  {
    ...
    contents: [
      "Saved 30+ hours per month by automating financial ETL routines in SQL, Power Query, advanced Excel, macros, and Python reporting scripts.",
      "Centralized operational and project data from 5+ construction sites into a unified SQL relational database for a $2.5M+ project portfolio.",
      "Designed Power BI dashboards with scheduled refreshes and budget-vs-actual variance analysis, helping prevent $250K+ in cost overruns.",
      "Improved data accuracy by 15% through structured data-entry templates, validation rules, and faster monthly reconciliation cycles.",
    ],
  },
];
